...
// Hash: 8d1d0ce2f8dba3201511757c16283e61b7e61af8dd19847423bf92685bd2b591
package capella
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.WithdrawalQueue); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("BeaconState.WithdrawalQueue", size, 1099511627776)
		return
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 10995119014401 {
		return ssz.ErrSize
	}

	tail := buf
	var o7, o9, o11, o12, o24, o25 uint64
	...
	// Offset (25) 'WithdrawalQueue'
	if o25 = ssz.ReadOffset(buf[10995119014381:10995119014385]); o25 > size || o24 > o25 {
		return ssz.ErrOffset
	}

	// Field (26) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = WithdrawalIndex(ssz.UnmarshallUint64(buf[10995119014385:10995119014393]))

	// Field (27) 'NextPartialWithdrawalValidatorIndex'
	b.NextPartialWithdrawalValidatorIndex = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[10995119014393:10995119014401]))
	...
	// Field (25) 'WithdrawalQueue'
	{
		...
		b.WithdrawalQueue = make([]*Withdrawal, num)
		for ii := 0; ii < num; ii++ {
			if b.WithdrawalQueue[ii] == nil {
				b.WithdrawalQueue[ii] = new(Withdrawal)
			}
