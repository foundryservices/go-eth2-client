...
// Hash: e149de274d02a184188fb51b9063f67736b3714c5286df884247048bede4bdc1
package altair
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 10995119014377 {
		return ssz.ErrSize
	}

	tail := buf
	var o7, o9, o11, o12 uint64
	...
	b.PreviousEpochParticipation = make([]ParticipationFlags, 1099511627776)
	for ii := 0; ii < 1099511627776; ii++ {
		b.PreviousEpochParticipation[ii] = ParticipationFlags(ssz.UnmarshallUint8(buf[2687248:1099514315024][ii*1 : (ii+1)*1]))
	}

	// Field (16) 'CurrentEpochParticipation'
	//b.CurrentEpochParticipation = ssz.ExtendUint8(b.CurrentEpochParticipation, 1099511627776)
	b.CurrentEpochParticipation = make([]ParticipationFlags, 1099511627776)
	for ii := 0; ii < 1099511627776; ii++ {
		b.CurrentEpochParticipation[ii] = ParticipationFlags(ssz.UnmarshallUint8(buf[1099514315024:2199025942800][ii*1 : (ii+1)*1]))
	}
